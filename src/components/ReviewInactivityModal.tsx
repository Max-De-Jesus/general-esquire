...
export const GOOGLE_REVIEW_URL = "https://g.page/r/Cb6OOUdT3CohEAE/review";

// Nom de l'événement personnalisé pour déclencher la modale
export const ESQUIRE_REVIEW_MODAL_EVENT = "open-esquire-review-modal";

// Fonction globale d'ouverture de la modale d'avis
export function openReviewModal() {
  if (typeof window !== "undefined") {
    window.dispatchEvent(new CustomEvent(ESQUIRE_REVIEW_MODAL_EVENT));
  }
}
      ...
      >
        ...
        <div className="inline-flex items-center justify-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1a3d28]/70 border border-[#C5A059]/50 shadow-[0_0_20px_rgba(197,160,89,0.25)] mb-3">
          ...
          <span className="text-xs sm:text-sm font-semibold uppercase tracking-wider font-cinzel text-[#E9D18F]">
            {lang === "fr" ? "Avis Google Officiel" : "Official Google Review"}
          </span>
        ...
        >
          {lang === "fr" ? "Votre avis compte pour nous" : "Your feedback matters to us"}
        </h2>
        ...
        <p className="font-cormorant text-base sm:text-lg text-[#EDE4CF] leading-relaxed mb-4 font-normal">
          {lang === "fr"
            ...
            : "Please kindly leave us a review to support our visibility and excellence."}
        </p>
        ...
        <a
          ...
          title={lang === "fr" ? "Cliquez pour ouvrir Google Avis dans un nouvel onglet" : "Click to open Google Reviews in a new tab"}
        >
          {/* Cadre du QR Code */}
          ...
          <div className="text-center sm:text-left space-y-1.5 flex-1">
            <p className="font-cinzel text-xs sm:text-sm font-bold uppercase tracking-wider text-[#E9D18F] group-hover:text-white transition-colors">
              {lang === "fr" ? "Scanner ou Cliquer pour ouvrir" : "Scan or Click to open"}
            </p>
            <p className="font-cormorant text-sm sm:text-base text-[#EDE4CF]/90 italic leading-snug">
              {lang === "fr"
                ...
                : "Point your smartphone camera or click directly on this card to open the review page in a new tab."}
            </p>
            <p className="text-[11px] text-[#C5A059] font-medium tracking-wide">
              {lang === "fr" ? "✦ Rapide, simple et sans inscription requise ✦" : "✦ Fast, simple and no sign-up required ✦"}
            </p>
          </div>
        </a>
        ...
        <p className="font-cormorant text-sm sm:text-base text-[#EDE4CF]/80 italic mb-4 whitespace-normal sm:whitespace-nowrap">
          {lang === "fr"
            ...
            : "Please click the button below or scan the code to leave your review."}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          >
            <span>{lang === "fr" ? "Donner mon avis sur Google" : "Leave a review on Google"}</span>
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
          ...
          >
            {lang === "fr" ? "Continuer la visite" : "Continue browsing"}
          </button>
        </div>
      </div>
    </div>
