    ...
    <div className="min-h-screen bg-[#0d0e0d]/50 text-[#EDE4CF] relative overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pb-12 md:pb-20">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-cinzel text-3xl sm:text-5xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-[#C5A059] via-[#E9D18F] to-[#C5A059] mt-4 mb-6">
