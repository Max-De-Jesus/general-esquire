          ...
          <section id="formulaire-cj" className="bg-[#131513] border border-[#C5A059]/40 rounded-3xl p-6 sm:p-10 shadow-2xl mb-12 animate-fade-in">
            ...
            {formSubmitted ? (
              <div className="p-8 rounded-2xl bg-[#0F3823]/80 border border-[#C5A059] text-center space-y-4">
                ...
                <div className="p-4 bg-[#131513] border border-[#C5A059]/40 rounded-xl text-left max-w-xl mx-auto space-y-2 text-xs font-cormorant text-[#EDE4CF] shadow-inner">
                  ...
                  <p className="leading-relaxed text-sm text-[#cabfa6]">
                    {lang === "fr" ? (
                      <>
                        ...
                        <br /><br />
                        <strong className="text-[#E9D18F]">2. Deuxième e-mail (Réponse & Récapitulatif) :</strong> C'est dans le second e-mail qui vous parvient immédiatement après que vous trouverez votre récapitulatif complet et la prise en charge de votre dossier.
                      </>
                    ) : (
                      <>
                        ...
                        <br /><br />
                        <strong className="text-[#E9D18F]">2. Second email (Response & Summary):</strong> Your complete summary and file details will arrive in the second email immediately following.
                      </>
                    )}
                  </p>
                </div>
              ...
              <form onSubmit={handleFormSubmit} className="space-y-6 font-cormorant text-base">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 min-w-0 max-w-full">
                  <div className="min-w-0 w-full">
                    ...
                    <div className="relative cursor-pointer min-w-0 w-full overflow-hidden rounded-xl">
                      <input
                        ...
                        className="w-full min-w-0 max-w-full block box-border px-4 py-3 pr-12 rounded-xl bg-[#0a0b0a] border border-[#C5A059]/40 text-[#EDE4CF] focus:border-[#E9D18F] focus:outline-none transition-colors [color-scheme:dark] cursor-pointer"
                      />
                  ...
                  <div className="min-w-0 w-full">
                    ...
                    <input
                      ...
                      className="w-full min-w-0 max-w-full block box-border px-4 py-3 rounded-xl bg-[#0a0b0a] border border-[#C5A059]/40 text-[#EDE4CF] focus:border-[#E9D18F] focus:outline-none transition-colors placeholder:text-gray-600"
                    />
                  </div>
                </div>
